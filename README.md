...
Pull requests and pushes to `main` or `codex/*` are automatically tested and checked by a Linux/amd64 Docker image build. The workflow validates the image but does not publish it yet.
