...
const en = {
  ...
  "settings.availableSoon": "Available soon",
  ...
  "settings.emailUpdated": "Your email address was updated. Please log in again.",
...
const de: Record<TranslationKey, string> = {
  ...
  "settings.availableSoon": "Demnächst verfügbar",
  ...
  "settings.emailUpdated": "Deine E-Mail-Adresse wurde aktualisiert. Bitte melde dich erneut an.",
  ...
  "settings.accountDeleted": "Dein Konto wurde gelöscht.",
};
